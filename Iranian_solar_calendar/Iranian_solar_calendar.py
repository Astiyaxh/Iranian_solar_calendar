...
print("Enter year[1399-1498]: ",end='',flush=True)
year = int(input())
while flag == 0:
    if year < 1399 or year > 1498:
        print("Try again! \nEnter another year[1399-1498]: ",end='',flush=True)
        year = int(input())
    else:
        flag = 1
flag = 0
...
print("Enter month[1-12]: ",end='',flush=True)
month = int(input())
while flag == 0:
    if month < 1 or month > 12:
        print("Try again! \nEnter another month[1-12]: ",end='',flush=True)
        month = int(input())
    else:
        flag = 1
flag = 0

print("Enter day[1-31|30|29]:",end='',flush=True)
day = int(input())
while flag == 0:
